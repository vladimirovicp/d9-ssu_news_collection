...
class NewsSubdivisionListing extends ControllerBase
{
    private $page;
    private $total_pages;
    ...
    public function view($subdivision)
    {
        // Сохраняем параметр подразделения для использования в пагинации
        $this->subdivision = $subdivision;
        
        // Проверка существования страницы по пути /struktura/{$subdivision}
        $path_alias = '/struktura/' . $subdivision;
        ...
        return [
            '#theme' => 'news-subdivision-listing',
            '#content' => $content,
    ...
    public function getPaginationLinks()
    {
        ...
        // Добавляем параметр подразделения для использования в ссылках пагинации
        if($this->subdivision){
