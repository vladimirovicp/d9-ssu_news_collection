...
class NewsSubdivisionChildListing extends ControllerBase
{
    private $page;
    private $total_pages;
    ...
    public function view($subdivision, $subdivision_child)
    {
        ...
        $path_alias = '/struktura/' . $subdivision . '/' . $subdivision_child;
        ...
        return [
            '#theme' => 'news-subdivision-child-listing',
            '#content' => $content,
